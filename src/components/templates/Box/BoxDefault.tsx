...
export function TemplateBoxDefault({
  ...
  return (
    <Container.Flex className="mx-4 w-[680px] flex-col gap-8 laptop:mx-0">
      <Container.Flex className="laptop-px-4 flex-col gap-4 rounded-xl border-t-4 border-secondary bg-gradient-to-b from-suport-100 to-suport-300 p-4 px-3 shadow-lg shadow-secondary laptop:p-8">
        <Container.Flex className="flex-col">
          <Text.Title className="text-3xl text-secondary laptop:text-5xl">
            {title}
          </Text.Title>
          <Text.Title className="text-subtitle text-2xl laptop:text-4xl">
            {subtitle}
          </Text.Title>
        </Container.Flex>
        <TemplateText.Block
